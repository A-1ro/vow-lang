...
use vow_syntax::ast;
use vow_syntax::{Position as SynPosition, Span as SynSpan};
...
mod codes {
    pub const UNDEFINED_NAME: &str = "VOW-E1001";
    pub const UNDEFINED_TYPE: &str = "VOW-E1002";
    pub const DUPLICATE_DEF: &str = "VOW-E1003";
    pub const IMPORT_CONFLICT: &str = "VOW-E1004";
    pub const TYPE_MISMATCH: &str = "VOW-E2001";
    pub const UNKNOWN_FIELD: &str = "VOW-E2002";
    pub const UNKNOWN_VARIANT: &str = "VOW-E2003";
    pub const RECORD_LITERAL: &str = "VOW-E2004";
    pub const TAGGED_CONFUSION: &str = "VOW-E2005";
    pub const TYPE_ARITY: &str = "VOW-E2006";
    pub const EFFECT_UNDECLARED: &str = "VOW-E3001";
    pub const UNKNOWN_EFFECT: &str = "VOW-E3002";
    pub const IMPURE_CONTRACT: &str = "VOW-E4001";
    pub const CONTRACT_CONSTRUCT: &str = "VOW-E4002";
}
