...
use pact_syntax::ast;
use pact_syntax::{Position as SynPosition, Span as SynSpan};
...
mod codes {
    pub const UNDEFINED_NAME: &str = "PACT-E1001";
    pub const UNDEFINED_TYPE: &str = "PACT-E1002";
    pub const DUPLICATE_DEF: &str = "PACT-E1003";
    pub const IMPORT_CONFLICT: &str = "PACT-E1004";
    pub const TYPE_MISMATCH: &str = "PACT-E2001";
    pub const UNKNOWN_FIELD: &str = "PACT-E2002";
    pub const UNKNOWN_VARIANT: &str = "PACT-E2003";
    pub const RECORD_LITERAL: &str = "PACT-E2004";
    pub const TAGGED_CONFUSION: &str = "PACT-E2005";
    pub const TYPE_ARITY: &str = "PACT-E2006";
    pub const EFFECT_UNDECLARED: &str = "PACT-E3001";
    pub const UNKNOWN_EFFECT: &str = "PACT-E3002";
    pub const IMPURE_CONTRACT: &str = "PACT-E4001";
    pub const CONTRACT_CONSTRUCT: &str = "PACT-E4002";
}
